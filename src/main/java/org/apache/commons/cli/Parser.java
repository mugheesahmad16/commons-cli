...
public abstract class Parser implements CommandLineParser {
     ...
     *                        parsing and the remaining arguments
     *                        are added to the {@link CommandLine}s args list. If
     *                        {@code false} an unrecognized argument triggers a
     *                        ParseException.
     * @return the {@code CommandLine}
     * @throws ParseException if an error occurs when parsing the arguments.
     */
    @Override
    public CommandLine parse(final Options options, final String[] arguments, final boolean stopAtNonOption)
            throws ParseException {
     ...
     * values retrieved from the specified
     * iterator {@code iter}.
     *
     * @param opt  The current Option
     * @param iter The iterator over the flattened command line Options.
     * @throws ParseException if an argument value is required and it is has not
     *                        been found.
     */
    ...
    /**
     * Process the Option specified by {@code arg} using the values retrieved from
    ...
    protected void processOption(final String arg, final ListIterator<String> iter) throws ParseException {
        ...
        final Option originalOption = getOptions().getOption(arg);
        final Option opt = new Option(originalOption);
     ...
     * @throws ParseException if there are any problems encountered while processing
     *                        the properties.
     */
    protected void processProperties(final Properties properties) throws ParseException {
        ...
        for (final Enumeration<?> e = properties.propertyNames(); e.hasMoreElements();) {
            ...
            // if the option is part of a group, check if another option of the group has
            // been selected
